...
void GBufferToOutput_GP::CreateDescriptorLayout()
{
    ...
    VulkanUtility::DebugNameObject("GBufferToOutput_GP_DescriptorSetLayout", reinterpret_cast<uint64_t>(vkDescriptorSetLayout), VK_OBJECT_TYPE_DESCRIPTOR_SET_LAYOUT);
}

void GBufferToOutput_GP::CreatePipeline(const VkRenderPass& vkRenderPass)
{
    // Get shader code
    ...
    colorBlendAttachment.dstAlphaBlendFactor = VK_BLEND_FACTOR_DST_ALPHA; // Optional
    ...
    VulkanUtility::DebugNameObject("GBufferToOutput_GP_PipelineLayout", reinterpret_cast<uint64_t>(vkPipelineLayout), VK_OBJECT_TYPE_PIPELINE_LAYOUT);
    ...
    VulkanUtility::DebugNameObject("GBufferToOutput_GP_Pipeline", reinterpret_cast<uint64_t>(vkPipeline), VK_OBJECT_TYPE_PIPELINE);
...
void GBufferToOutput_GP::Shutdown() {
