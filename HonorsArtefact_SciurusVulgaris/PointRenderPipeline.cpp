...
//void PointRenderPipeline::CreateImages()
//{
//}
//
//void PointRenderPipeline::CreateSampler()
//{
//}

//void PointRenderPipeline::CreateRenderPass()
//{
//}
//
//void PointRenderPipeline::CreateFrameBuffer()
//{
//}

void PointRenderPipeline::CreateDescriptorLayout()
{
...
void PointRenderPipeline::CreatePipeline()
{
    // Get shader code
    ...
    VulkanUtility::DebugNameObject("PointRenderPipeline_UGP_PipelineLayout", reinterpret_cast<uint64_t>(vkMainPipelineLayout), VK_OBJECT_TYPE_PIPELINE_LAYOUT);
    ...
    VulkanUtility::DebugNameObject("PointRenderPipeline_UGP_Pipeline", reinterpret_cast<uint64_t>(vkMainPipeline), VK_OBJECT_TYPE_PIPELINE);
...
void PointRenderPipeline::BeginRender(HMM_Vec4 clearColor, VkCommandBuffer commandBuffer)
{
...
void PointRenderPipeline::Render(PointMesh* points, VkCommandBuffer commandBuffer)
{
    if (commandBuffer == VK_NULL_HANDLE) commandBuffer = Graphics::GetThisFramesCommandBuffer();
