...
void PointsToGBuffer_GP::CreateDescriptorLayout()
{
    ...
    vkDescriptorSetLayoutInfo.bindingCount = 7;
    ...
    VulkanUtility::DebugNameObject("PointsToGBuffer_GP_DescriptorSetLayout", reinterpret_cast<uint64_t>(vkDescriptorSetLayout), VK_OBJECT_TYPE_DESCRIPTOR_SET_LAYOUT);
}

void PointsToGBuffer_GP::CreatePipeline(const VkRenderPass& vkRenderPass)
{
    // Get shader code
    ...
    VulkanUtility::DebugNameObject("PointsToGBuffer_GP_PipelineLayout", reinterpret_cast<uint64_t>(vkPipelineLayout), VK_OBJECT_TYPE_PIPELINE_LAYOUT);
    ...
    VulkanUtility::DebugNameObject("PointsToGBuffer_GP_Pipeline", reinterpret_cast<uint64_t>(vkPipeline), VK_OBJECT_TYPE_PIPELINE);
...
void PointsToGBuffer_GP::Shutdown() {
