...
void PointsToShadowMeshShade_GP::CreateDescriptorLayout()
{
    ...
    VulkanUtility::DebugNameObject("PointsToShadowMeshShade_GP_DescriptorSetLayout", reinterpret_cast<uint64_t>(vkDescriptorSetLayout), VK_OBJECT_TYPE_DESCRIPTOR_SET_LAYOUT);
}
...
void PointsToShadowMeshShade_GP::CreatePipeline(const VkRenderPass& vkRenderPass)
{
    ...
    VulkanUtility::DebugNameObject("PointsToShadowMeshShade_GP_PipelineLayout", reinterpret_cast<uint64_t>(vkPipelineLayout), VK_OBJECT_TYPE_PIPELINE_LAYOUT);
    ...
    VulkanUtility::DebugNameObject("PointsToShadowMeshShade_GP_Pipeline", reinterpret_cast<uint64_t>(vkPipeline), VK_OBJECT_TYPE_PIPELINE);
