...
void Skybox_GP::CreateDescriptorLayout()
{
    ...
    VulkanUtility::DebugNameObject("Skybox_GP_DescriptorSetLayout", reinterpret_cast<uint64_t>(vkDescriptorSetLayout), VK_OBJECT_TYPE_DESCRIPTOR_SET_LAYOUT);
}

void Skybox_GP::CreatePipeline(const VkRenderPass& vkRenderPass)
{
    // Get shader code

    auto vertShaderCode = VulkanUtility::ReadFile("./COMPILEDSHADER_MeshVertex.spv");
    auto fragShaderCode = VulkanUtility::ReadFile("./COMPILEDSHADER_Skybox.spv");
    ...
    VkPipelineColorBlendAttachmentState blendStateAttachmentList[1] = { colorBlendAttachment};
    ...
    VulkanUtility::DebugNameObject("Skybox_GP_PipelineLayout", reinterpret_cast<uint64_t>(vkPipelineLayout), VK_OBJECT_TYPE_PIPELINE_LAYOUT);
    ...
    VulkanUtility::DebugNameObject("Skybox_GP_Pipeline", reinterpret_cast<uint64_t>(vkPipeline), VK_OBJECT_TYPE_PIPELINE);
