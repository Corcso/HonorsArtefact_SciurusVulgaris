...
/// <summary>
/// List of static setup functions to create and setup different vulkan components. References to things like renderpass and such will be swap chain resources.
/// Code mostly from (Overvoorde, 2023)
